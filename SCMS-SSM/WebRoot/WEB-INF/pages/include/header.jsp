  ...
  <div class="container-fluid">
    <div class="navbar-header" style="height: 80px;">
      ...
      <a class="navbar-brand" href="${pageContext.request.contextPath }/home">
      	<img src="${pageContext.request.contextPath }/resources/images/logo.png" alt="" width="55px" height="55px">
      </a>
      <a class="navbar-brand" href="${pageContext.request.contextPath }/home">
    	...
    	<c:otherwise>
		    ...
		    <div id="navbar" class="navbar-collapse collapse" style="height: 80px;">
		        ...
		        <ul class="dropdown-menu" style="margin-top: 12px;">
		          ...
		          <li><a href="${pageContext.request.contextPath }/user/logout"><span class="glyphicon glyphicon-log-out"></span>&nbsp;退出登录</a></li>
		        </ul>
		      </li>
		     </ul>
		    </div>
